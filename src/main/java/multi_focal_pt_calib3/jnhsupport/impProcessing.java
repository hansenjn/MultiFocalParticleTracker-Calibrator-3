package multi_focal_pt_calib3.jnhsupport;
...
public class impProcessing {
	...
	public static double getInterpolatedIntensity2D (ImagePlus imp, double px, double py, int z){
			double x = px / imp.getCalibration().pixelWidth;
			double y = py / imp.getCalibration().pixelHeight;
